package  
{
	 ...
	 * @author AARON
	 */
	public class tFire_tower extends Tower
	{
		var mTimeSmash;
		
		public function tFire_tower(BOARD, y_pos = 0, x_pos = 0, type = "tFire_tower", speed = 4000,
			level = 0, health = 100, attack = 10, range = 30, color = "NONE" )
		{
			var t = "t_fire_tower";
			
			var upgd:Array = [250, 100, 200, 300];		
			...
			mUpgradeText = ["EAT 25 CARS", "EAT 25 CARS", "EAT 25 CARS", "EAT 25 CARS"];
		}
		...
		override function FreqCallJunkFunc()
		{
			...
			if ( mMovieClip )
			{
				...
				{
					mTimeSmash = mBoard.mGlobalTimer;
					var aoe:AreaOfEffect = new AOE_Fire_tower( this, new Point(mX, mY) );
					mLevel = 1;
					RemoveMe();	
				}
			}
